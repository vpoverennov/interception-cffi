...
assert lib.INTERCEPTION_KEY_UP << 1 == lib.INTERCEPTION_FILTER_KEY_UP
assert lib.INTERCEPTION_KEY_E0 << 1 == lib.INTERCEPTION_FILTER_KEY_E0
assert lib.INTERCEPTION_KEY_E1 << 1 == lib.INTERCEPTION_FILTER_KEY_E1
assert lib.INTERCEPTION_KEY_TERMSRV_SET_LED << 1 == lib.INTERCEPTION_FILTER_KEY_TERMSRV_SET_LED
assert lib.INTERCEPTION_KEY_TERMSRV_SHADOW << 1 == lib.INTERCEPTION_FILTER_KEY_TERMSRV_SHADOW
assert lib.INTERCEPTION_KEY_TERMSRV_VKPACKET << 1 == lib.INTERCEPTION_FILTER_KEY_TERMSRV_VKPACKET
